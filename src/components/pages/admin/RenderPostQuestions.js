import { Box, Button, Grid, GridItem, Stack, Text, Flex, useBoolean } from "@chakra-ui/react";
...
function RenderPostQuestions({ index, push, remove, values, insert }) {
              ...
              <Flex justifyContent="center">
                <Box mr="1">
                  <FiCopy
                    ...
                    onClick={() => insert(index + 1, values?.questions[index])}
                    cursor="pointer"
                  />
                </Box>
                <Box ml="1">
...
export default RenderPostQuestions;
