...
const SurveyResponseTab = ({ placement = "PRE_COURSE", assessments: assessmentAnwers, fetchUserAssessmentAnswers }) => {
  ...
  const columns = [
...

    {
      ...
      width: 350,
      cellRenderer: (params) => {
        return <Text>{params.data?.timeSpent}s</Text>;
      },
    },
    {
      header: "",
...
SurveyResponseTab.defaultProps = {
  responses: "responses",
  number: "4",
};
