...
const AdminUsersPage = () => {
  ...
  const fetchUsers = (query = {}) => {
    api
      .get(ADMIN_USERS + "?" + new URLSearchParams(query))
      .then((response) => {
  ...
  return (
    <Layout>
      <Flex justifyContent="space-between" alignItems="end">
        ...
        <Box>
          <Flex>
            <WithPermissionWrapper permission="adminPrimary">
            ...
            <Modal closeOnOverlayClick={false} isOpen={isOpen} size="6xl" onClose={onClose} w="100%">
              ...
              <ModalContent>
                ...
                <ModalCloseButton />
                <ModalBody>
                  <AdminUsersForm fetchUsers={fetchUsers} onClose={onClose} />
                </ModalBody>
              </ModalContent>
            </Modal>
          </Flex>
